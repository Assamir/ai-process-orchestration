...
R-033 (read-before-you-write standing rule) in **v0.23.0**. The backlog below is currently empty — add
the next stack/feature work here._

## Backlog (unscheduled)

_Empty — every tracked item through R-033 is shipped. Add new `R-###` items here as they are scoped._
