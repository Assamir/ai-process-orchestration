...
backlog below is empty — all scoped work is scheduled._
...
_Empty — all scoped items are scheduled. Newly scoped `R-###` items will land here before scheduling._
