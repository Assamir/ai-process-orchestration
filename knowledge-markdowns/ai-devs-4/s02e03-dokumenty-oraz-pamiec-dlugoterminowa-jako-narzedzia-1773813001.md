...
cover_image: '[https://cloud.overment.com/thinking-1773302525.png](https://cloud.overment.com/thinking-1773302525.png)'
circle_post_id: 30573309

https://vimeo.com/1172919468
...
Poniżej mamy przykład sytuacji w której w rzeczywistości (lewa strona) dokumenty są ze sobą **powiązane**. Jednak w praktyce (prawa strona), agent dociera tylko do pierwszego z nich, bez pogłębiania wyszukiwania, ponieważ **docB** może wyglądać na kompletny.

Problem rozumienia dokumentu w szerszym kontekście
...
Przykład dziennika logów z Observational Memory
...
Schemat działania Observational Memory
...
Niezależnie od tego, czy będziemy korzystać z Observational Memory, czy nie, schemat myślenia którym podążali jego autorzy jest tym, na którym w AIdevs najbardziej nam zależy. Kod źródłowy projektu można znaleźć [na Githubie](https://github.com/mastra-ai/mastra).
...
Różnica pomiędzy przeszukiwaniem istniejącej bazy, a tworzeniem bazy dla agenta
...
Schemat eksploracji informacji według procedur stworzonych z myślą o agentach AI
...
Przykład agenta nawigującego po kodzie źródłowym
...
Porównanie połączenia ze źródłem z nauką ze źródła
...
Przykład współpracy pomiędzy agentami tworzącymi spersonalizowany newsletter
...
Przykład działania agenta posługującego się grafem jako pamięcią
...
- **mergeentities**: ułatwia weryfikowanie poprawności grafu (np. wykrywanie duplikatów)

Narzędzia agenta posługującego się grafem
...
Doprecyzowywanie oraz parafraza zapytania użytkownika przed Deep Research
...
- **Nie przekraczaj 1500 tokenów** - to twarde ograniczenie systemu Centrali. Możesz sprawdzić liczbę tokenów na [https://platform.openai.com/tokenizer](https://platform.openai.com/tokenizer)
